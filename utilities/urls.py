...
from utilities.views import validates_date, validates_kids_date, fix_date, check_valid_date, change_kids_date, \
    set_new_broadcast, get_user_id_by_username, set_chatfuel_variable, GetMonthsView, EnGetMonthsView
...
urlpatterns = [
    ...
    path('en_child_months/', EnGetMonthsView.as_view(), name="get_months_en")
]
